...
import 'package:mvmis/components/main_page.dart';
  ...
  Widget build(BuildContext context) {
    return Consumer<PageOffsetNotifier>(
      ...
      child: Padding(
        ...
        child: Text(
          'Feline Motors is a German automobile manufacturer specializing in high-performance sports cars, SUVs and sedans.',
